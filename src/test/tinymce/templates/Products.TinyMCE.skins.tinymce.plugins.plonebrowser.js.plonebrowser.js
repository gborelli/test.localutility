...
BrowserDialog.prototype.insertImage = function () {
    ...
    // check description or title field
    var error_msg = 'Please, fill description field',
        id_to_check = '#description';
    if (active_panel === "#external") {
        id_to_check = '#imagetitle';
        error_msg = 'Please, fill title field';
    }

    if (jq(id_to_check, document).val() === "") {
        window.uploadError(error_msg);
        return false
    }
